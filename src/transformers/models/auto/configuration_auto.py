...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("darkidol", "DarkidolConfig"),
        ("darkidol_text", "DarkidolTextConfig"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("darkidol", "DarkidolForConditionalGeneration"),
        ("darkidol_text", "DarkidolForCausalLM"),
